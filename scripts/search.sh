...
export DECAF_VENV_FOLDER="$DECAF_CONTAINER_ROOT_FOLDER/venv"

# The folder where all models are stored.
export DECAF_MODELS_FOLDER="$DECAF_CONTAINER_ROOT_FOLDER/models"
...
export DECAF_PYTHON_ERROR_LOG_FILENAME="$DECAF_CONTAINER_ROOT_FOLDER/python_errors.txt"
...
java -jar $DECAF_CONTAINER_ROOT_FOLDER/target/"$DECAF_JAR_FILENAME" -s $DECAF_CONTAINER_ROOT_FOLDER/config/search.properties 2>&1
